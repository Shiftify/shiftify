...
public class GregCal_DateTime_Converter implements PropertyConverter<GregorianCalendar, String> {
    @Override
    public GregorianCalendar convertToEntityProperty(String databaseValue) {
        return Utilities.StrToGregCal(databaseValue, Utilities.CalType.DATETIME);
    }
    @Override
    public String convertToDatabaseValue(GregorianCalendar entityProperty) {
        return Utilities.GregCalToStr(entityProperty, Utilities.CalType.DATETIME);
    }
}
