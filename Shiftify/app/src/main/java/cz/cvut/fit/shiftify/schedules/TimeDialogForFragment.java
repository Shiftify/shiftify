...
/**
 * Created by Ilia on 29-Apr-17.
 */

public class TimeDialogForFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public static TimeDialogForFragment newInstance() {
        Bundle args = new Bundle();
        TimeDialogForFragment fragment = new TimeDialogForFragment();
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (TimeDialogCallback) getTargetFragment();
        } catch (ClassCastException e) {
            throw new ClassCastException(getTargetFragment().toString() + " must implement " + TimeDialogCallback.class.getName());
        }
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mType = args.getInt(TIME_TYPE_ARG);
    ...
    interface TimeDialogCallback {
        void onTimeSet(LocalTime localTime, int timeType);
    }
}
